...
var require_shopify_buy = __commonJS({
  "node_modules/shopify-buy/index.js"(exports, module) {
    ...
    var slicedToArray$1 = /* @__PURE__ */ (function() {
    ...
    var Client$2 = (function() {
      function Client2(typeBundle, _ref) {
    ...
    var InputMapper = (function() {
      function InputMapper2() {
        classCallCheck$1(this, InputMapper2);
      }
      createClass$1(InputMapper2, [{
        key: "create",
    ...
    function discountMapper(_ref) {
      var cartLineItems = _ref.cartLineItems, cartDiscountAllocations = _ref.cartDiscountAllocations, cartDiscountCodes = _ref.cartDiscountCodes;
      ...
      var _cartDiscountAllocati = cartDiscountAllocations.reduce(function(acc, discountAllocation) {
        ...
        return acc;
      }, [[], []]), _cartDiscountAllocati2 = slicedToArray$1(_cartDiscountAllocati, 2), shippingDiscountAllocations = _cartDiscountAllocati2[0], orderLevelDiscountAllocations = _cartDiscountAllocati2[1];
    ...
    function mergeCartOrderLevelDiscountAllocationsToCartLineDiscountAllocations(_ref2) {
      var lineItems = _ref2.lineItems, orderLevelDiscountAllocationsForLines = _ref2.orderLevelDiscountAllocationsForLines;
    ...
    function generateDiscountApplications(cartLinesWithAllDiscountAllocations, shippingDiscountAllocations, discountCodes) {
      var discountIdToDiscountApplicationMap = /* @__PURE__ */ new Map();
    ...
    function mapLineItems(lines, discountApplications) {
      var skipDiscounts = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
    ...
    function userErrorsMapper(userErrors) {
      return userErrors.map(function(_ref) {
        var code = _ref.code, field = _ref.field, message = _ref.message;
        return {
          // eslint-disable-next-line no-undefined
          code: code ? CartErrorCodeToCheckoutErrorCode[code] : void 0,
          field,
          message
        };
      });
    ...
    function warningsMapper(warnings) {
      return warnings.map(function(_ref2) {
        var code = _ref2.code, message = _ref2.message;
        return {
          // eslint-disable-next-line no-undefined
          code: code ? CartWarningCodeToCheckoutErrorCode[code] : void 0,
          message
        };
      });
    }
      ...
      return function(_ref) {
        ...
        if (rootData && rootData.cart) {
          return client.fetchAllPages(rootModel.cart.lines, { pageSize: 250 }).then(function(lines) {
            ...
            var checkoutUserErrors2 = checkoutUserErrorsMapper(rootData.userErrors, rootData.warnings);
            try {
              return Object.assign({}, mapCartPayload(rootModel.cart, mutationRootKey), { userErrors: checkoutUserErrors2, errors: rootModel.cart.errors });
            } catch (error) {
    ...
    function query$12(client) {
      ...
      spreads.CartLineFragment = document.defineFragment("CartLineFragment", "BaseCartLine", function(root) {
        ...
        root.add("merchandise", function(merchandise) {
          merchandise.addInlineFragmentOn("ProductVariant", function(ProductVariant2) {
            ProductVariant2.add("id");
            ProductVariant2.add("title");
            ProductVariant2.add("image", function(image) {
              image.add("id");
              image.add("url", {
                alias: "src"
              });
            ...
            ProductVariant2.add("product", function(product) {
              product.add("id");
              product.add("handle");
              product.add("title");
            });
            ProductVariant2.add("weight");
            ProductVariant2.add("availableForSale", {
              alias: "available"
            });
            ProductVariant2.add("sku");
            ProductVariant2.add("selectedOptions", function(selectedOptions) {
              selectedOptions.add("name");
              selectedOptions.add("value");
            });
            ProductVariant2.add("compareAtPrice", function(compareAtPrice) {
              compareAtPrice.add("amount");
              compareAtPrice.add("currencyCode");
            });
            ProductVariant2.add("price", function(price) {
              price.add("amount");
              price.add("currencyCode");
            });
            ProductVariant2.add("unitPrice", function(unitPrice) {
              unitPrice.add("amount");
              unitPrice.add("currencyCode");
            });
            ProductVariant2.add("unitPriceMeasurement", function(unitPriceMeasurement) {
              unitPriceMeasurement.add("measuredType");
              unitPriceMeasurement.add("quantityUnit");
              unitPriceMeasurement.add("quantityValue");
              unitPriceMeasurement.add("referenceUnit");
        ...
        root.add("discountAllocations", function(discountAllocations) {
          ...
          discountAllocations.addInlineFragmentOn("CartCodeDiscountAllocation", function(CartCodeDiscountAllocation2) {
            CartCodeDiscountAllocation2.add("code");
          });
          discountAllocations.addInlineFragmentOn("CartAutomaticDiscountAllocation", function(CartAutomaticDiscountAllocation2) {
            CartAutomaticDiscountAllocation2.add("title");
          });
          discountAllocations.addInlineFragmentOn("CartCustomDiscountAllocation", function(CartCustomDiscountAllocation2) {
            CartCustomDiscountAllocation2.add("title");
          });
        });
      });
      ...
      spreads.CartFragment = document.defineFragment("CartFragment", "Cart", function(root) {
        ...
        root.add("buyerIdentity", function(buyerIdentity) {
          ...
          buyerIdentity.add("deliveryAddressPreferences", function(deliveryAddressPreferences) {
            deliveryAddressPreferences.addInlineFragmentOn("MailingAddress", function(MailingAddress2) {
              MailingAddress2.add("address1");
              MailingAddress2.add("address2");
              MailingAddress2.add("city");
              MailingAddress2.add("company");
              MailingAddress2.add("country");
              MailingAddress2.add("countryCodeV2");
              MailingAddress2.add("firstName");
              MailingAddress2.add("formatted");
              MailingAddress2.add("formattedArea");
              MailingAddress2.add("lastName");
              MailingAddress2.add("latitude");
              MailingAddress2.add("longitude");
              MailingAddress2.add("name");
              MailingAddress2.add("phone");
              MailingAddress2.add("province");
              MailingAddress2.add("provinceCode");
              MailingAddress2.add("zip");
            });
          });
        });
          ...
          deliveryGroups.add("edges", function(edges) {
            edges.add("node", function(node) {
              ...
              node.add("cartLines", {
                ...
                cartLines.add("edges", function(edges2) {
                  edges2.add("cursor");
                  edges2.add("node", function(node2) {
                    node2.add("id");
                  });
    ...
    var CheckoutResource = (function(_Resource) {
      ...
      createClass$1(CheckoutResource2, [{
        ...
        value: function fetch2(id) {
          var _this2 = this;
          return this.graphQLClient.send(query$12, { id }).then(function(_ref) {
            var model = _ref.model, data = _ref.data;
            return new Promise(function(resolve, reject) {
              try {
        ...
        value: function create() {
          ...
          return this.graphQLClient.send(query$13, { input }).then(handleCartMutation("cartCreate", this.graphQLClient));
        }
        /**
        ...
        value: function updateAttributes(checkoutId) {
          ...
          var _inputMapper$updateAt = this.inputMapper.updateAttributes(checkoutId, input), cartAttributesUpdateInput = _inputMapper$updateAt.cartAttributesUpdateInput, cartNoteUpdateInput = _inputMapper$updateAt.cartNoteUpdateInput;
          ...
          if (cartAttributesUpdateInput.attributes.length) {
            promise = promise.then(function() {
              return updateAttributes2.call(_this3);
            });
          }
          return promise;
        }
        ...
        value: function addLineItems(checkoutId) {
          var lineItems = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [];
        ...
        value: function addDiscount(checkoutId, discountCode) {
          ...
          return this.graphQLClient.send(query$12, { id: checkoutId }).then(function(_ref2) {
            var model = _ref2.model, data = _ref2.data;
            return new Promise(function(resolve, reject) {
              try {
                var cart = data.cart || data.node;
                if (!cart) {
        ...
        value: function removeLineItems(checkoutId) {
          var lineIds = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [];
    ...
    var Client = (function() {
      createClass$1(Client2, null, [{
        ...
        value: function buildClient(config, fetchFunction) {
          ...
          var client = new Client2(newConfig, Client$2, fetchFunction);
...
export default require_shopify_buy();
//# sourceMappingURL=shopify-buy.js.map
